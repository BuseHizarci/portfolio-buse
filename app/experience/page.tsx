...
const Experience = () => {
  return (
    <div className="flex flex-col items-center p-8 sm:p-16 relative">
      <Navbar />
      <Particles
        className="absolute inset-0 z-[-10] animate-fade-in bg-slate-800"
        quantity={900}
      />
      <div className="container mx-auto relative border-s border-gray-700">
        <h2 className="text-2xl sm:text-3xl lg:text-4xl text-center p-4 text-purple-700">
